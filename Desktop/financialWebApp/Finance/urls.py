...
from .views import (index,add_students,student_edit,process_payment,
                    ...
                    level_summary,session_summary,session_summary_pdf,import_excel,add_students_upload)
...
urlpatterns = [
    ...
    path("add-students-upload/", add_students_upload, name="students_import"),
    ...
    path("edit_students/<int:student_id1>/", student_edit, name="edit_student"),
