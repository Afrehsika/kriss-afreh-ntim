...
def process_payment(request, student_id):
    ...
    if request.method == "POST":
        ...
        message = f"Dear {student.name}, your payment of GHS{paid_amount} as your SRC fees, has been successfully received."
        api_key = "UXJnRnpWSmt5dkNkSVBWeHRod0k"
        sender_id = "ARCE SRC"
        send_sms(api_key, message, sender_id, student.phone)
